...
const regionsData = [
  ...
  { slug:"negev",
    ...
    speciesLatin:["Daboia palaestinae","Cerastes cerastes","Cerastes gasperettii","Cerastes vipera","Pseudocerastes fieldi","Echis coloratus","Atractaspis engaddensis","Walterinnesia aegyptia","Dolichophis jugularis","Spalerosophis diadema","Hemorrhois nummifer","Platyceps rogersi","Platyceps collaris","Psammophis schokari","Telescopus fallax","Eryx jaculus","Xerotyphlops vermicularis","Pseudopus apodus","Psammophis aegyptius","Platyceps saharicus","Platyceps elegantissimus","Platyceps sinai","Lytorhynchus diadema","Macroprotodon cucullatus","Leptotyphlops macrorhynchus","Telescopus dhara","Telescopus hoogstraali","Rhynchocalamus melanocephalus","Eirenis coronelloides","Rhagerhis moilensis"] },
  ...
  { slug:"arava-eilat",
    ...
    speciesLatin:["Cerastes gasperettii","Echis coloratus","Atractaspis engaddensis","Walterinnesia aegyptia","Spalerosophis diadema","Platyceps rogersi","Psammophis schokari","Xerotyphlops vermicularis","Pseudopus apodus","Platyceps saharicus","Platyceps elegantissimus","Platyceps sinai","Leptotyphlops macrorhynchus","Telescopus dhara","Telescopus hoogstraali","Rhagerhis moilensis"] },
  ...
  { slug:"jordan-valley-dead-sea",
    ...
    speciesLatin:["Echis coloratus","Atractaspis engaddensis","Walterinnesia aegyptia","Spalerosophis diadema","Platyceps rogersi","Psammophis schokari","Xerotyphlops vermicularis","Pseudopus apodus","Psammophis aegyptius","Platyceps saharicus","Platyceps sinai","Leptotyphlops macrorhynchus","Rhynchocalamus melanocephalus","Eirenis coronelloides","Micrelaps muelleri"] },
  ...
  { slug:"galilee-hermon",
    ...
    speciesLatin:["Montivipera bornmuelleri","Daboia palaestinae","Dolichophis jugularis","Hemorrhois nummifer","Platyceps collaris","Psammophis schokari","Telescopus fallax","Eryx jaculus","Xerotyphlops vermicularis","Pseudopus apodus","Zamenis hohenackeri","Elaphe druzei","Micrelaps muelleri","Rhynchocalamus melanocephalus","Eirenis rothii","Eirenis lineomaculatus","Eirenis decemlineatus","Eirenis levantinus"] },
  ...
  { slug:"mediterranean-coastal",
    ...
    speciesLatin:["Daboia palaestinae","Dolichophis jugularis","Malpolon insignitus","Spalerosophis diadema","Hemorrhois nummifer","Platyceps collaris","Psammophis schokari","Natrix tessellata","Telescopus fallax","Eryx jaculus","Xerotyphlops vermicularis","Pseudopus apodus","Micrelaps muelleri","Lytorhynchus diadema","Macroprotodon cucullatus","Eirenis lineomaculatus","Eirenis decemlineatus"] }
